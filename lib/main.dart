        ...
        builder: (context, snapshot) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              DatabaseHelper().updateMonthlyFee(
                studentId: doc.id,
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("Confirm Monthly Payment",
                style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
            Text(name,
        ...
        content: Text(
          "Mark this month's fee ₹${amount.toStringAsFixed(0)} as paid?",
          style: const TextStyle(color: AppColors.textSecondary, fontSize: 14),
        ),
        actions: [
          ...
          ElevatedButton(
           ...
           onPressed: () async {
              await _dbHelper.markMonthlyPaid(
                studentId: studentId,
                monthlyFee: amount,   // amount should be batch monthly fee
              );
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String currentMonth = "${DateTime.now().year}-${DateTime.now().month}";
                          String lastPaidMonth = doc["last_fee_paid_month"] ?? "";

                          final isFullyPaid = lastPaidMonth == currentMonth;
                          final due = isFullyPaid ? 0 : monthlyFee;

                          double remaining = due.toDouble();
